...
O Prometheus descobre cada réplica diretamente por DNS do Compose, sem scrape pelo balanceador nem socket Docker. O receiver publica a quantidade desejada lida de expected-replicas. Perda de um target reduz capacidade; pode ocorrer com o probe ainda saudável.
