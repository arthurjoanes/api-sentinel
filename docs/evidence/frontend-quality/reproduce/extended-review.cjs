...
(async()=>{
 ...
 const base='http://127.0.0.1:9816', results={checkedAt:new Date().toISOString(),data:[],performance:[],controls:[]};
 try {
  ...
  fs.writeFileSync('.runtime/quality/extended-review.json',JSON.stringify(results,null,2));
