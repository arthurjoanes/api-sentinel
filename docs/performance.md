...
A primeira tentativa desse cenário usou oito VUs e perdeu seis chegadas: reprovada, preservada em [load-pool-pressure-generator-limited.json](../artifacts/load-pool-pressure-generator-limited.json). Foi repetida com 24 VUs pré-alocados, sem drops. A última repetição após correção do gauge gerou 201 conclusões, sendo 194/503 e 7/200; a liberação do lock coincidiu com o fim da janela. A execução reprovada não fundamenta conclusão de capacidade.
